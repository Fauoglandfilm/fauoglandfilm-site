...
export const metadata = buildMetadata({
  title: "Profil",
  description: "Oppdater markedsplassprofilen din i Filmlanseren.",
  path: "/frilanseren/dashboard/profil",
});
...
export default async function FrilanserenProfilePage() {
  ...
  return (
    <ProtectedRouteShell
      title="Rediger profilen din"
      description="Oppdater informasjonen som styrer hvordan profilen vises i markedsplassen."
    >
      <AuthCard>
        <ProfileForm
