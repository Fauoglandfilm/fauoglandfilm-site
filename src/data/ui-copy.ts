export const uiCopy = {
  header: {
    no: {
      ...
      menuClose: "Lukk meny",
      searchOpen: "Åpne søk",
      searchClose: "Lukk søk",
      searchLabel: "Søk",
      searchPlaceholder: "Søk etter tjenester, case eller profiler",
      searchEmpty: "Ingen treff ennå. Prøv for eksempel reklamefilm, Ville Gleder eller Tommy.",
      languageLabel: "Språk",
      themeLabel: "Tema",
    },
    en: {
      ...
      searchLabel: "Search",
      searchPlaceholder: "Search services, case studies or profiles",
      searchEmpty: "No results yet. Try commercial film, Ville Gleder or Tommy.",
  ...
  footer: {
    no: {
      ...
      conversionTitle: "Denne nettsiden er laget for å gjøre interesse om til booking.",
      conversionDescription: "Det samme bygger vi for dere.",
    ...
    en: {
      ...
      conversionTitle: "This site is built to turn interest into bookings.",
      conversionDescription: "That is what we build for you too.",
  ...
  pages: {
    no: {
      ...
      servicesHeroTitle: "Film som gjør tilbudet\ntydelig og salget enklere",
    ...
    en: {
      ...
      servicesHeroTitle: "Film that makes the offer\nclearer and sales easier",
      servicesHeroDescription:
